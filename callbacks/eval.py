...
class KGCNMetric(tf.keras.callbacks.Callback):
    def __init__(self, x_train, y_train, x_valid, y_valid,aggregator_type,dataset,K_fold,batch_size, out_folder):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        aupr = average_precision_score(y_true=y_true, y_score=y_pred, average='macro')
        ...
        write_log(f'{config.LOG_DIR}/{self.out_folder}/{config.EPOCH_END_LOG.format(self.dataset)}',log_list,mode='a')
